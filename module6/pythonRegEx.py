...
\b 			Returns a match where the specified characters are 				r"\bain"
			at the beginning or at the end of a word (the "r" in the 		r"ain\b"
			beginning is making sure that the string is being 
			treated as a "raw string") 									
																		 	

\B 			Returns a match where the specified characters are present,		r"\Bain" 
			but NOT at the beginning (or at the end) of a word (the "r" 	r"ain\B"
			in the beginning is making sure that the string is being 
			treated as a "raw string") 	
...
\S 			Returns a match where the string DOES NOT contains				"\S" 
			a white space character 	 	
...
\W 			Returns a match where the string DOES NOT contains				"\W" 
			any word characters 	 	
...
mystr = "You're gonna love it!"

x = re.findall("Spain", mystr)
print (x)
...
newstr = "The rain in Spain"
x = re.search("\s", newstr)
