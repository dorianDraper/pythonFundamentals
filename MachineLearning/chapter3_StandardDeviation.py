...
x = np.std(speed)
y = np.std(speed1)
print ("This is a low standard deviation: ")
print (x)
print()
print ("Whereas this is a high standard deviation: ")
print (y)
...
x = np.var(speed)
print ("The variance of these values 32,111,138,28,59,77,97 is: ")
print (x)
"""
Standard Deviation
...
print ("And the standard deviation is the square root of that value: ")
print (x)
"""
Symbols
