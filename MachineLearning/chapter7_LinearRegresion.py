...
In Machine Learning, and in statistical modeling, that relationship is used
...
linear regression. We will show you how to use these methods instead of going through the mathematic formula.
...
Execute a method that returns some important key values of Linear Regression:
    ...
    slope, intercept, r, p, std_err = stats.linregress(x, y)
        slope in math means graph line inclination
...
the x-axis and the values of the y-axis is, if there are no relationship the
linear regression can not be used to predict anything.
