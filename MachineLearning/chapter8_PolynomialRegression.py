...
to draw a line of polynomial regression. We will show you how to use these methods
...
feed it with the x and y arrays. scikit-learn is a Python module for machine learning built on top of SciPy
...
print ("The result 0.94 shows that there is a good relationship: ")
...
print ("Predicting the speed of a car passing at 17pm")
print (speed)
...
print ("The following is a bad fit for polynomial regression: ")
print (r2_score(y, mymodel(x)))
"""
The result: 0.00995 indicates a very bad relationship, and tells us that this data set
is not suitable for polynomial regression.
"""
